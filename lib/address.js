...
const address = {
  ...
  community() {
    return utils.draw(["\#{community_prefix} \#{community_suffix}"])
  },
  street_suffix() {
  ...
  city() {
    return utils.draw(["\#{city_prefix} \#{Name.first_name}\#{city_suffix}", "\#{city_prefix} \#{Name.first_name}", "\#{Name.first_name}\#{city_suffix}", "\#{Name.last_name}\#{city_suffix}"])
  },
  street_name() {
    return utils.draw(["\#{Name.first_name} \#{street_suffix}", "\#{Name.last_name} \#{street_suffix}"])
  },
  street_address() {
    return utils.draw(["\#{building_number} \#{street_name}"])
  },
  full_address() {
    return utils.draw(["\#{street_address}, \#{city}, \#{state_abbr} \#{zip_code}", "\#{secondary_address} \#{street_address}, \#{city}, \#{state_abbr} \#{zip_code}"])
  },
  default_country() {
