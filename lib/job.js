...
const job = {
  ...
  title() {
    return utils.draw([`${this.seniority()} ${this.field()} ${this.position()}`, `${this.seniority()} ${this.field()} ${this.position()}`, `${this.field()} ${this.position()}`, `${this.field()} ${this.position()}`, `${this.seniority()} ${this.position()}`])
  },
};
